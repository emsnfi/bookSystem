...
namespace Forum.Services
{
    ...
    {
        private string gmail_account = "emsnfi@gmail.com"; //Gmail帳號
        private string gmail_password = "emily506411"; //Gmail密碼
        private string gmail_mail = "emsnfi@gmail.com"; //Gmail信箱
